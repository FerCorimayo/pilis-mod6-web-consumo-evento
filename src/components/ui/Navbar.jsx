      ...
      <div className="px-2 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="relative flex items-center justify-between h-16">
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            <button type="txt" className="relative rounded-full bg-[#005b8e]-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
              <span className="absolute -inset-1.5"></span>
              <span className="sr-only">View notifications</span>
              <p>{currentUser.fullname} - {currentUser.role}</p>
            </button>
      ...
      <div className="sm:hidden" id="mobile-menu">
        <div className="px-2 pt-2 pb-3 space-y-1">
          ...
          <NavLink to="/vendedores" >
            <label className="block px-3 py-2 text-base font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white cursor-pointer">Vendedores</label>
          </NavLink>
          <NavLink to="/clientes" >
            <label className="block px-3 py-2 text-base font-medium text-gray-300 rounded-md hover:bg-gray-700 hover:text-white cursor-pointer">Clientes</label>
          </NavLink>
        </div>
      </div>
    </nav>    
