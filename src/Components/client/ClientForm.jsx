  ...
  const updateForm = () => {
    if (clientRegistered) {
      if(clientRegistered.modo==1 || clientRegistered.modo==2){
        setValue('text',clientRegistered?.user?.fullname)
        setValue('text1',clientRegistered?.user?.email)
        setValue('text2',clientRegistered?.user?.dni)
      }
      return;
    }
    ...
    return (
        ...
        <div className="flex justify-center p-2 bg-gray-400 sm:p-3 md:p-5">
          ...
          {clientRegistered.modo==0 && <h4 className="col-span-2 p-5 pb-0 text-2xl font-bold text-gray-500 border-b border-gray-500 sm:pb-5" >Nuevo Usuario</h4>}
          {clientRegistered.modo==1 && <h4 className="col-span-2 p-5 pb-0 text-2xl font-bold text-gray-500 border-b border-gray-500 sm:pb-5" >Editar Usuario de {clientRegistered.user.fullname}</h4>}
          {clientRegistered.modo==2 && <h4 className="col-span-2 p-5 pb-0 text-2xl font-bold text-gray-500 border-b border-gray-500 sm:pb-5" >Ver Informacion de {clientRegistered.user.fullname}</h4>}
